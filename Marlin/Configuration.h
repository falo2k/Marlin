...
#define STRING_CONFIG_H_AUTHOR "(Oli's Custom E3 F/W)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  25.85,  22.20 }
    #define DEFAULT_Ki_LIST {   2.54,   1.08 }
    #define DEFAULT_Kd_LIST { 65.8, 114.00 }
  #else
    #define DEFAULT_Kp 25.85
    #define DEFAULT_Ki 2.54
    #define DEFAULT_Kd 65.8
  #endif
#endif // PIDTEMP
 ...
 */
 // OW NOTE: Set this to M204 P800 with PLA
...
// Removing 10mm off front and back for clips vs nozzle + frame limit
